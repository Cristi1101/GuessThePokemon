...
public class StartAfterLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_after_login2);
    ...
    void tryagain(){
        new CountDownTimer(1500, 1) {
            ...
            public void onFinish() {
                ...
                editor.putInt("lastScore", intpuncte);
                editor.apply();

                Toast.makeText(getApplicationContext(), "You Lost! Score: "+intpuncte, Toast.LENGTH_LONG).show();
                Intent revine_la_meniu = new Intent(StartAfterLogin.this, MenuAfterLogin.class);
